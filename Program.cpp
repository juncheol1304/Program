...
using namespace std; // std 를 앞에 붙히지 않아도됨
...
#pragma region 접근 지정자
	...
	// public : 클래스 내부와 자기가 상속하고 클래스 그래고 클래스
...
#pragma region 클래스
	...
	// 
	// cout << "object1.x : " << object1.getX() << endl;
	// cout << "object2.x : " << object2.getX() << endl;
	// cout << "object3.x : " << object3.getX() << endl;
